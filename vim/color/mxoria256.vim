...
let colors_name = "mxoria256" " modified xoria256
"}}}
" Colours {{{1
"" General {{{2
...
hi LineNr       ctermfg=247 guifg=#9e9e9e             guibg=#121212
...
hi SpellCap     ctermfg=189 guifg=#dfdfff             guibg=bg      cterm=underline gui=underline
hi SpellRare    ctermfg=168 guifg=#df5f87             guibg=bg      cterm=underline gui=underline
hi SpellLocal   ctermfg=98  guifg=#875fdf             guibg=bg      cterm=underline gui=underline
...
""" vimdiff {{{3
hi diffAdd                  guifg=bg      ctermbg=4 guibg=#afdfaf
hi diffDelete               guifg=bg      ctermbg=1 guibg=#949494 cterm=none gui=none
hi diffChange               guifg=bg      ctermbg=96 guibg=#dfafaf cterm=none gui=none
hi diffText                 guifg=bg      ctermbg=53 guibg=#df8787 cterm=none gui=none
""" HTML {{{3
